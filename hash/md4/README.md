...
- **Publicación original:** 1990 ([RFC 1186](https://www.rfc-editor.org/rfc/rfc1186)), 1992 especificación de referencia ([RFC 1320](https://www.rfc-editor.org/rfc/rfc1320)).
...
La salida se calcula concatenando las palabras **A0**, **B0**, **C0** y **D0** resultantes de la última compresión, empezando por el byte de menor peso de **A0** y acabando por el byte de mayor peso de **D0**. El siguiente es un ejemplo de MD4("").

```txt
┌───────────────┬───────────────────────────────────┐
│ A0 0xE0CFD631 │ digest = {0x31, 0xD6, 0xCF, 0xE0, │
│ B0 0x31E96AD1 │           0xD1, 0x6A, 0xE9, 0x31, │
│ C0 0xD7593CB7 │           0xB7, 0x3C, 0x59, 0xD7, │
│ D0 0xC089C0E0 │           0xE0, 0xC0, 0x89, 0xC0} │
└───────────────┴───────────────────────────────────┘
```
